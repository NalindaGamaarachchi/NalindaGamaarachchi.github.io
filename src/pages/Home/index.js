...
const disciplines = ['Student', 'Developer']
...
const Home = () => {
    ...
    useEffect(() => {
        ...
        const handleHashchange = (hash, scroll) => {
            ...
            const hashSections = [intro, details]
    ...
    return (
        <div className="home">
            <Helmet>
                <title>Hello,I'm | Nalinda Gamaarachchi </title>
                <meta
                    name="description"
                    content="Portfolio of Nalinda Gamaarachchi – a devloper working"
                />
